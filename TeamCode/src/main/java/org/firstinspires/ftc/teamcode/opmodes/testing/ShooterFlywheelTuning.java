...
public class ShooterFlywheelTuning extends OpMode {
    ...
    private void tick() {
        ...
        telemetry.addData("flywheel.leftRpm", flywheel.getLeftRpm());
        telemetry.addData("flywheel.rightRpm", flywheel.getRightRpm());
        telemetry.addData("flywheel.averageRpm", (flywheel.getLeftRpm() + flywheel.getRightRpm()) / 2);
        telemetry.addData("flywheel.encoderDifferenceRpm", Math.abs(flywheel.getLeftRpm() - flywheel.getRightRpm()));
        ...
        telemetry.addData("Output limited / both at speed", flywheel.isOutputLimited() + " / " + flywheel.isAtSpeed());
