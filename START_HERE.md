...
For hood and vision integration,
start with [Launcher Prototype](docs/LAUNCHER_PROTOTYPE.md). It includes bench
controls, hood calibration, and optional chassis AprilTag alignment.
